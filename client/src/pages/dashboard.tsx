...
import type { Customer, Project, Lead, SurveyRecord, Admin, LdrContact, LdrCareer, ClientRegister } from "@shared/schema";
...
export default function Dashboard() {
  ...
  const { data: surveyRecords = [], isLoading: surveyRecordsLoading } = useQuery<SurveyRecord[]>({
  ...
  const { data: ldrContacts = [], isLoading: contactsLoading } = useQuery<LdrContact[]>({
    queryKey: ["/api/ldr-contacts"],
  });

  const { data: ldrCareers = [], isLoading: careersLoading } = useQuery<LdrCareer[]>({
    queryKey: ["/api/ldr-careers"],
  });

  const { data: clientRegisters = [], isLoading: clientRegistersLoading } = useQuery<ClientRegister[]>({
